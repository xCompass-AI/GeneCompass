...
class non_celltype_GRN_model:
    ...
    def init_data(self, Path, model, dataset_path, checkpoint_path, get_emb, prior_embedding_path = None):
        ...
        #pkl_file = open('/home/cnic02/yangqm/projects/国乐老师/embedding/Immune_Human_gene_name.pkl', 'rb')

        #embed_gene_index = pickle.load(pkl_file)
        #pkl_file.close()
        #print(embed_gene_index)
    ...
    def train_model(self):
        ...
        #dataloader, Evaluate_Mask, num_nodes, num_genes, data, truth_edges, TFmask2, gene_name = self.init_geneformer_data()
