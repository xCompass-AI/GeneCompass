...
#Path = '/disk1/xCompass/'
Path = os.path.abspath(__file__)[:-75]
...
save_path = Path + 'downstream_tasks/drug_dose_response/cpa/result'
...
emb_file = Path + 'downstream_tasks/drug_dose_response/GeneCompass-emb-0708.npy'
