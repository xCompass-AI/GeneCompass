"""
genecompass precollator and pretrainer.
...
from .data_collator import DataCollatorForLanguageModelingModified

from .utils import TOKEN_DICTIONARY_PATH
...
class GenecompassPretrainer(Trainer):
    def __init__(self, *args, **kwargs):
        ...
        if data_collator is None:
            precollator = GenecompassPreCollator(token_dictionary=token_dictionary)

            # # Data Collator Functions
            data_collator = DataCollatorForLanguageModelingModified(
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        if labels is not None:
            ...
            id_loss = outputs["id_loss"] if isinstance(outputs, dict) else outputs[0]
