...
data_file = Path + 'grn_inference/DeepSEM-master/BEELINE-data/inputs/scRNA-Seq/hESC/BL-hESC-ChIP-seq-no-peca-ExpressionData.csv'
net_file = Path + 'grn_inference/DeepSEM-master/BEELINE-data/inputs/scRNA-Seq/hESC/BL-hESC-ChIP-seq-no-peca-network.csv'
get_emb = True
n_epochs = 40
...
save_name = Path + 'grn_inference/DeepSEM-master/result/GeneCompass_cls_new-emb-0708'
...
emb_file_path = Path + 'grn_inference/GeneCompass-emb-0708.npy'
