...
class DataCollatorForLanguageModelingModified(DataCollatorForLanguageModeling):
    ...
    def torch_mask_tokens(self, inputs: Any, values: Any,special_tokens_mask: Optional[Any] = None) -> Tuple[Any, Any]:
        ...
        # values[indices_replaced] = self.tokenizer.convert_tokens_to_ids(self.tokenizer.mask_token)
        ...
        # random_values = torch.randn(labels.shape, dtype=torch.float32) * 8
        # values[indices_random] = random_values[indices_random]
